...
/**
 * @title AlphaToken
 * @dev This is the first ERC-20 token for the SimpleDEX.
 * It inherits from OpenZeppelin's ERC20 and Ownable contracts.
 * The initial supply is minted to the deployer of the contract.
 */
contract AlphaToken is ERC20, Ownable {
     ...
     */
    constructor(address initialOwner) ERC20("AlphaToken", "ALPHA") Ownable(initialOwner) {
